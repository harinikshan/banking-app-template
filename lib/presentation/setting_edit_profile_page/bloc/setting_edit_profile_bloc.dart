import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:diwise_app_for_banking_template/presentation/setting_edit_profile_page/models/setting_edit_profile_model.dart';import 'package:diwise_app_for_banking_template/data/models/me/get_me_resp.dart';import 'dart:async';import 'package:diwise_app_for_banking_template/data/repository/repository.dart';import 'package:fluttertoast/fluttertoast.dart';part 'setting_edit_profile_event.dart';part 'setting_edit_profile_state.dart';class SettingEditProfileBloc extends Bloc<SettingEditProfileEvent, SettingEditProfileState> {SettingEditProfileBloc(SettingEditProfileState initialState) : super(initialState) { on<SettingEditProfileInitialEvent>(_onInitialize); on<ChangeDropDownEvent>(_changeDropDown);on<FetchMeEvent>(_callFetchMe); }
...
Fluttertoast.showToast(msg: "test".toString(),); }
 }
